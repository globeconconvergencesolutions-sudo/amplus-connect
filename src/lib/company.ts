export const COMPANY = {
  ...
  // Replace these three with the live Amplus contacts before launch.
  phone: "+254 700 000 000",
  email: "hello@amplus.co.ke",
  address: "Amplus House, Mombasa Road, Nairobi, Kenya",
  hours: "Mon – Fri, 8:00 – 17:30 · Sat, 8:00 – 13:00",
  mapQuery: "Mombasa Road, Nairobi, Kenya",
};
